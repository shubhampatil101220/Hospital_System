	...
	<div class="container-fluid">
		...
		<c:if test="${not empty userObj }">
			...
			<li class="nav-item"><a class="nav-link active"
				 ...
				 data-bs-toggle="dropdown" aria-expanded="false"> <i class="fa-solid fa-circle-user"></i>  ${userObj.fullname }</button>
        
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuButton1">
